...
export const metadata: Metadata = {
  ...
  title: "GLEE — Onchain Pixel Art",
  description: "Create a tiny onchain masterpiece on a 9×9 pixel canvas.",
  openGraph: { title: "GLEE — Onchain Pixel Art", description: "Create a tiny onchain masterpiece on a 9×9 pixel canvas.", url: SITE_URL, siteName: "GLEE" },
  twitter: { card: "summary_large_image", title: "GLEE — Onchain Pixel Art", description: "Create a tiny onchain masterpiece on a 9×9 pixel canvas." },
};
